...
public class LCDWriteTWIBlock extends TranslatorBlock
{
	public LCDWriteTWIBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
	...
	public String toCode() throws SocketNullException, SubroutineNotDeclaredException
	{
		...
		translator.addDefinitionCommand("LiquidCrystal lcd("+tempo1+");\n");		

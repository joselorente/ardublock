...
public class SevenSegmentSetupBlock extends TranslatorBlock
{
	public SevenSegmentSetupBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
	...
	public String toCode() throws SocketNullException, SubroutineNotDeclaredException
	{
		...
		ret +="matrix.setBrightness( ";
		TranslatorBlock tb = getRequiredTranslatorBlockAtSocket(1);
		ret = ret + tb.toCode();
		ret = ret + " );\n";
		ret = ret + "matrix.blinkRate( ";
